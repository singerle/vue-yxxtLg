  ...
  <el-container class="statis">
    <el-aside width="130px" class="aside">
      <el-menu :default-active="index" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" text-color="#777777" active-text-color="#2184C5" @select="selectItem">
        ...
        <el-menu-item index="4" v-if="rolesStatis[4]">
          <span slot="title">班级数据导出</span>
        </el-menu-item>
      </el-menu>
...
<script>
  const PATH = ['/statis/index/synthesis', '/statis/index/business', '/statis/index/comb', '/statis/index/traffic','/statis/index/share']
  ...
  export default {
    ...
    created(){console.log(this.rolesStatis)},
    computed: {
      ...mapGetters([
        'index', 'rolesStatis'
      ])
