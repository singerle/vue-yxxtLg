<template>
    <div class="newsCentral-wrapper">
      <el-table class="newstable" :data="tableData"  style="width: 100%">
        <el-table-column prop="tblx" label="同步类型">
          <!-- <template slot-scope="scope">
            <img :src="scope.row.cropImg" alt="picture">
          </template> -->
        </el-table-column>
        <el-table-column prop="tbzt" label="同步状态"></el-table-column>
        <el-table-column prop="czr" label="操作人" ></el-table-column>
        <el-table-column prop="tbsj" :formatter="fmtDate" label="同步时间" > </el-table-column>
        <el-table-column prop="xzsj" label="新增数据" > </el-table-column>
