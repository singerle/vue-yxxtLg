<template>
    <div class="newsCentral-wrapper">
      <el-table class="newstable" :data="tableData"  style="width: 100%">
        <el-table-column prop="tblx" label="序号">
          <!-- <template slot-scope="scope">
            <img :src="scope.row.cropImg" alt="picture">
          </template> -->
        </el-table-column>
        <el-table-column prop="xy" label="学院" style="display:none"></el-table-column>
        <el-table-column prop="zy" label="专业" style="display:none"></el-table-column>
