...
<template>
	<div class="bdlc-xcjf">
    	...
    	<div class="prement" v-html="this.$changetext.jfdt">
<!--     		<h3>新同学：你好！</h3>
    		<p>
				<span style="display:inline-block;text-indent: 2em">欢迎加入重庆工商大学，当你看到本页面缴费数据后即可进行缴费,学校为你提供以下4种缴费方式</span>
				</br>
				1、按照入学须知要求，把学费打入指定银行卡，通过银行代扣；</br>
				2、关注“重庆工商大学财务处”公众号，通过微信缴费；</br>
				3、登录学校门户（网址：http://portal.ctbu.edu.cn）</br>
				进入“财务系统”中的“统一支付平台”自主进行网上缴费，支付方式有银联卡支付、微信支付两种方式；</br>
				4、到校后到指定地点缴费（费时费力，不推荐）。</br>
				注：新生编学号后就有正式帐户了，用户名为学号，密码统一为ctbu+身份证后六位,不含+号
	    	</p> -->
	    	<!-- <h3>重要提醒：</h3>
	...
	data(){
		return {
			info:[
				...
				// {fymc:"书费",yjje:500.2,yjfy:"0",qfje:500,hjje:0,jffs:"现场"},
