...
<!-- 点击放弃购买过后显示的页面 -->
<template>
	<div class="wrap" style="font-size:.14rem">\
		<template v-html="this.$changetext.bxgm.fqgm">
		<!-- <h3>重庆市大学生城乡居民合作医疗保险介绍</h3>
		...
		<router-link to="/bxgmFqgmJh1">
			<div class="bottom">
		  		<span class="tip">自愿放弃购买</span>
			</div>
		</router-link>
	</div>
</template>
