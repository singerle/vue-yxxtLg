<template>
    ...
    <topSelect :toptitle="toptitle"></topSelect>
      ...
      <template v-if="flag">
        ...
        <hjObj class="mb10" :data="wsxx" :sylx="sylx" :titleD="{name:'完善信息',func_dq:'getXqjbxx',func_xy:'getXqjbxx'}" v-if="wsxx.length>0"></hjObj>
        <hjObj class="mb10" :data="bxgm" :sylx="sylx" :titleD="{name:'保险购买',func_dq:'getXqbxgm',func_xy:'getXybxgm'}" v-if="bxgm.length>0"></hjObj>
        <hjObj class="mb10" :data="lstd" :sylx="sylx" :titleD="{name:'绿色通道',func_dq:'getXqlstd',func_xy:'getXylstd'}" v-if="lstd.length>0"></hjObj>
  ...
  methods: {
    ...
    backindex(bool){
      if(bool){
        ...
        this.flag = true
        this.toptitle = this.toptitle + '迎新统计'
      }
    },
    getHomeInfo(xq,lx){
      this.bxgm = []
