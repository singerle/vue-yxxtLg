...
export default {
  ...
  data () {
    return {
			// dqxq: '',
    	dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd: '本科生迎新统计',			
    	active: false
    }
  },
  watch: {
  	xqList(val, old){
  		if(val.length>0){
  			this.dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd = val[0]
  		}
  	}
  },
  props: ['xqList'],
  methods: {
  	...
  	checkObj(xq){
  		this.dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd = xq
  		this.active = false
  		this.set_xq(xq)
